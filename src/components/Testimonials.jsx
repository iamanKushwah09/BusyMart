...
const testimonials = [
  {
    ...
    content: 'BusyMart transformed our boutique into a global powerhouse. Their integration services are next-level!',
    rating: 5
  },
  {
    name: 'David Chen',
    ...
    <section className="py-24 bg-mesh">
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-black font-display mb-4">Trusted by Market Leaders</h2>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {testimonials.map((t, i) => (
            ...
            >
              ...
              <p className="text-white/70 italic leading-relaxed">"{t.content}"</p>
            </motion.div>
          ))}
        </div>
      </div>
